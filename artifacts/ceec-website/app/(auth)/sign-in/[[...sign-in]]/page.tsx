      ...
      <Card>
        ...
        <form onSubmit={handleVerify} style={s.form}>
          ...
          {errors && errors.length > 0 && (
            <Err>{errors[0].longMessage ?? errors[0].message}</Err>
          )}
    ...
    <Card>
      ...
      <form onSubmit={handleSubmit} style={s.form}>
        ...
        <input
          ...
          required
        />
        {errors && (errors as { fields?: { identifier?: { message: string } } }).fields?.identifier && (
          <Err>{(errors as any).fields.identifier.message}</Err>
        )}
      ...
      <Link href="/sign-up" style={s.linkBtn}>Créer un compte</Link>
...
const s = {
  ...
  ghostBtn: {
    marginTop: 6, padding: "8px 0", borderRadius: 8, border: "none",
