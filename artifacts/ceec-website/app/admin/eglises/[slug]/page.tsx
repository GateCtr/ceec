      ...
      <main style={{ minHeight: "100vh", background: "#f8fafc" }}>
        <div style={{ background: "linear-gradient(135deg, #1e3a8a, #1e2d6b)", color: "white", padding: "2.5rem 1rem" }}>
          <div style={{ maxWidth: 1000, margin: "0 auto" }}>
            <Link href="/admin/eglises" style={{ color: "rgba(255,255,255,0.7)", fontSize: 13, textDecoration: "none", display: "inline-flex", alignItems: "center", gap: 6, marginBottom: 12 }}>
              ← Toutes les églises
            </Link>
            <div style={{ display: "flex", alignItems: "flex-start", gap: 16, flexWrap: "wrap", justifyContent: "space-between" }}>
              <div>
                <div style={{ display: "flex", alignItems: "center", gap: 12, marginBottom: 6 }}>
                  <h1 style={{ fontSize: "1.8rem", fontWeight: 800, margin: 0 }}>{eglise.nom}</h1>
                  <span style={{ background: statut.bg, color: statut.color, padding: "3px 12px", borderRadius: 100, fontSize: 12, fontWeight: 700 }}>
                    {statut.label}
                  </span>
                </div>
                <div style={{ color: "rgba(255,255,255,0.7)", fontSize: 14, display: "flex", gap: 20, flexWrap: "wrap" }}>
