        ...
        >
          ...
          <div>
            ...
            <div style={{ display: "flex", gap: 10, flexWrap: "wrap" }}>
              {social?.facebook && (
                <a href={social.facebook} target="_blank" rel="noopener noreferrer" title="Facebook" style={{ color: "#94a3b8", textDecoration: "none", fontSize: 18 }}>
                  <svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor"><path d="M18 2h-3a5 5 0 0 0-5 5v3H7v4h3v8h4v-8h3l1-4h-4V7a1 1 0 0 1 1-1h3z"/></svg>
                </a>
              )}
              {social?.youtube && (
                <a href={social.youtube} target="_blank" rel="noopener noreferrer" title="YouTube" style={{ color: "#94a3b8", textDecoration: "none" }}>
              ...
              {social?.instagram && (
                <a href={social.instagram} target="_blank" rel="noopener noreferrer" title="Instagram" style={{ color: "#94a3b8", textDecoration: "none" }}>
                  <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><rect x="2" y="2" width="20" height="20" rx="5" ry="5"/><path d="M16 11.37A4 4 0 1 1 12.63 8 4 4 0 0 1 16 11.37z"/><line x1="17.5" y1="6.5" x2="17.51" y2="6.5"/></svg>
                </a>
              )}
              {social?.twitter && (
                <a href={social.twitter} target="_blank" rel="noopener noreferrer" title="Twitter / X" style={{ color: "#94a3b8", textDecoration: "none" }}>
          ...
          <div>
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: 8, fontSize: 13 }}>
              ...
              {social?.siteWeb && (
                <a href={social.siteWeb} target="_blank" rel="noopener noreferrer" style={{ color: accent, textDecoration: "none", marginTop: 4 }}>
