    ...
    <div>
      <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 20, flexWrap: "wrap", gap: 10 }}>
        ...
        <div style={{ marginLeft: "auto", display: "flex", gap: 8 }}>
          ...
          <button onClick={openCreate} style={{ background: "#1e3a8a", color: "white", border: "none", borderRadius: 8, padding: "10px 20px", fontWeight: 700, fontSize: 14, cursor: "pointer", display: "inline-flex", alignItems: "center", gap: 6 }}>
                  ...
                  <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-start", gap: 12 }}>
                    ...
                    <div style={{ display: "flex", flexDirection: "column", gap: 6, flexShrink: 0, alignItems: "flex-end" }}>
                      <div style={{ display: "flex", gap: 6 }}>
                        <button onClick={() => openEdit(e)} style={s.editBtn} disabled={isLoading} title="Modifier">
                          <Pencil size={13} /> Modifier
                        </button>
                        <button onClick={() => handleDelete(e.id)} style={s.deleteBtn} disabled={isLoading} title="Supprimer">
